...
// use golangci-lint compatible with go 1.18, see https://github.com/golangci/golangci-lint/pull/2438
replace github.com/golangci/golangci-lint => github.com/ldez/golangci-lint v1.35.3-0.20220316225414-1e96cc444a66
