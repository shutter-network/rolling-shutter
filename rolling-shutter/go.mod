...
replace github.com/ethereum-optimism/optimism v1.1.6-rc.2 => ../../shoptimism/

replace github.com/ethereum/go-ethereum v1.13.1 => ../../shop-geth/
...
require (
	...
	github.com/shutter-network/shop-contracts v0.0.0-20231207133930-c9acef7fbf8e
