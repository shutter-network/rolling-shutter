...
func (x *DecryptionKeys) GetService() *ShutterServiceDecryptionKeysExtra {
	if x, ok := x.GetExtra().(*DecryptionKeys_Service); ok {
		return x.Service
	}
	return nil
}
...
var file_gossip_proto_rawDesc = []byte{
	...
	0x01, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x74, 0x72, 0x61, 0x63, 0x65, 0x42, 0x0b, 0x5a, 0x09, 0x2e,
	0x2f, 0x3b, 0x70, 0x32, 0x70, 0x6d, 0x73, 0x67, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_gossip_proto_depIdxs = []int32{
	...
	14, // 8: p2pmsg.Envelope.message:type_name -> google.protobuf.Any
...
func file_gossip_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_gossip_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ShutterServiceDecryptionKeySharesExtra); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_gossip_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ShutterServiceDecryptionKeysExtra); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_gossip_proto_msgTypes[10].OneofWrappers = []interface{}{
		(*DecryptionKeys_Gnosis)(nil),
		(*DecryptionKeys_Optimism)(nil),
		(*DecryptionKeys_Service)(nil),
	}
	file_gossip_proto_msgTypes[13].OneofWrappers = []interface{}{}
	type x struct{}
